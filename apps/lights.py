...
class Lights(ServiceHelper):
    def initialize(self):
        self.listen_state(self.lights_on, "binary_sensor.tur_kammer", new="on", light="light.decke_kammer", timer=300)
        self.listen_state(self.lights_off, "binary_sensor.tur_kammer", new="off", light="light.decke_kammer")
